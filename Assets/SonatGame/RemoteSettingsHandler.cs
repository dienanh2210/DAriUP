...
public class RemoteSettingsHandler : MonoBehaviour
{
    ...
    public string notify_day_title_value = "";
    public string notify_day_content_value = "";
    public string notify_week_title_value = "";
    public string notify_week_content_value = "";

    public int moves_reduction = 0;
